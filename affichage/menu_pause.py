...
def save_slot():
    ...
    rectangle(largeurFenetre * 0.55, hauteurFenetre * 0.07, largeurFenetre * 0.76, hauteurFenetre * 0.17,couleur = '#FF00FF',tag="save")#SLOT 1
    texte(largeurFenetre * 0.60, hauteurFenetre * 0.10,"SLOT 1",couleur="White",police="Arial Black",taille = taille_txt,tag="save")

    rectangle(largeurFenetre * 0.76, hauteurFenetre * 0.07, largeurFenetre * 0.97, hauteurFenetre * 0.17,couleur = '#FF00FF',tag="save")#SLOT 2
    texte(largeurFenetre * 0.81, hauteurFenetre * 0.10,"SLOT 2",couleur="White",police="Arial Black",taille = taille_txt,tag="save")

    rectangle(largeurFenetre * 0.55, hauteurFenetre * 0.17, largeurFenetre * 0.76, hauteurFenetre * 0.27,couleur = '#FF00FF',tag="save")#SLOT 3
    texte(largeurFenetre * 0.60, hauteurFenetre * 0.20,"SLOT 3",couleur="White",police="Arial Black",taille = taille_txt,tag="save")

    rectangle(largeurFenetre * 0.76, hauteurFenetre * 0.17, largeurFenetre * 0.97, hauteurFenetre * 0.27,couleur = '#FF00FF',tag="save")#SLOT 4
    texte(largeurFenetre * 0.81, hauteurFenetre * 0.20,"SLOT 4",couleur="White",police="Arial Black",taille = taille_txt,tag="save")

    rectangle(largeurFenetre * 0.55, hauteurFenetre * 0.27, largeurFenetre * 0.76, hauteurFenetre * 0.37,couleur = '#FF00FF',tag="save")#SLOT 5
    texte(largeurFenetre * 0.60, hauteurFenetre * 0.30,"SLOT 5",couleur="White",police="Arial Black",taille = taille_txt,tag="save")

    rectangle(largeurFenetre * 0.76, hauteurFenetre * 0.27, largeurFenetre * 0.97, hauteurFenetre * 0.37,couleur = '#FF00FF',tag="save")#SLOT 6
    texte(largeurFenetre * 0.81, hauteurFenetre * 0.30,"SLOT 6",couleur="White",police="Arial Black",taille = taille_txt,tag="save")
